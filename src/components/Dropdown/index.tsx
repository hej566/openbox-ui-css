...
function Dropdown(props: PropsTypes) {
    ...
    return (
        <div className="dropdown">
            {split ? (
                <ButtonGroup>
                    <Button variant={variant} size={size} disabled={disabled}>{buttonName}</Button>
                    <Button variant={variant} SuffixIcon={suffixIcon} refButton={dropdownButtonRef} size={size} disabled={disabled}/>
                </ButtonGroup>     
            ) : (
                <Button variant={variant} SuffixIcon={suffixIcon} refButton={dropdownButtonRef} size={size} disabled={disabled}>{buttonName}</Button>
            )}
